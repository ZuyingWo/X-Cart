 ...
 */
class Region extends \XLite\Model\Region implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'code', 'name', 'weight', 'country', 'states', '_previous_state');
        }
