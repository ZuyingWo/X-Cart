 ...
 */
class Store extends \XLite\Module\XC\MailChimp\Model\Store implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'list', 'main', '_previous_state');
        }
    ...
    public function isMain()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isMain', array());
