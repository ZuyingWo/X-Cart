 ...
 */
class Tab extends \XLite\Module\XC\CustomProductTabs\Model\Product\Tab implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'position', 'enabled', 'product', 'editLanguage', 'translations', '_previous_state');
        }
