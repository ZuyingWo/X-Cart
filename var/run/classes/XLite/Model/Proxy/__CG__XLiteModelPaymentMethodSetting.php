 ...
 */
class MethodSetting extends \XLite\Model\Payment\MethodSetting implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'setting_id', 'name', 'value', 'payment_method', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MethodSetting $proxy) {
    ...
    public function getSettingId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSettingId', array());

        return parent::getSettingId();
    }
