 ...
 */
class AddressFieldTranslation extends \XLite\Model\AddressFieldTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AddressFieldTranslation $proxy) {
