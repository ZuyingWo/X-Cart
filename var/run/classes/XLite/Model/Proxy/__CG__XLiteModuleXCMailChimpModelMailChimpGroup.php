...
class MailChimpGroup extends \XLite\Module\XC\MailChimp\Model\MailChimpGroup implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'list', 'names', 'type', 'enabled', '_previous_state');
        }
    ...
    public function getEnabledNames()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEnabledNames', array());
    ...
    public function addNames(\XLite\Module\XC\MailChimp\Model\MailChimpGroupName $names)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addNames', array($names));
