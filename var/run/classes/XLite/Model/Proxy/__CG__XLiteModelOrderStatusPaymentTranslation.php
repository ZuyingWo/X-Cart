 ...
 */
class PaymentTranslation extends \XLite\Model\Order\Status\PaymentTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PaymentTranslation $proxy) {
