...
namespace XLite\Model\Proxy\__CG__\XLite\Module\XC\ThemeTweaker\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Template extends \XLite\Module\XC\ThemeTweaker\Model\Template implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'template', 'date', '_previous_state');
        }
