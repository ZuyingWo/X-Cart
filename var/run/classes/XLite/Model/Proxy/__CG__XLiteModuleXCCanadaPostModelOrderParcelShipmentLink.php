 ...
 */
class Link extends \XLite\Module\XC\CanadaPost\Model\Order\Parcel\Shipment\Link implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'shipment', 'storage', 'id', 'rel', 'href', 'idx', 'mediaType', 'apiCallErrors', '_previous_state');
        }
