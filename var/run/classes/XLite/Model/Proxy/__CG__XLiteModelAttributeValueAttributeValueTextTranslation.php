 ...
 */
class AttributeValueTextTranslation extends \XLite\Model\AttributeValue\AttributeValueTextTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'value', 'label_id', 'code', 'owner', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AttributeValueTextTranslation $proxy) {
