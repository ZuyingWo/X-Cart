 ...
 */
class Item extends \XLite\Module\XC\CanadaPost\Model\ProductsReturn\Item implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'return', 'orderItem', 'amount', '_previous_state');
        }
