...
class OrderDetail extends \XLite\Model\OrderDetail implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'detail_id', 'name', 'label', 'value', 'order', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OrderDetail $proxy) {
    ...
    public function getDetailId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDetailId', array());
