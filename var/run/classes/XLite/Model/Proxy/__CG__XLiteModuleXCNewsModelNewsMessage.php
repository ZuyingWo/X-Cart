 ...
 */
class NewsMessage extends \XLite\Module\XC\News\Model\NewsMessage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'enabled', 'date', 'cleanURLs', 'metaDescType', 'editLanguage', 'translations', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NewsMessage $proxy) {
