 ...
 */
class SearchFilterTranslation extends \XLite\Model\SearchFilterTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SearchFilterTranslation $proxy) {
