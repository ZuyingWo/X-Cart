 ...
 */
class AttributeOption extends \XLite\Model\AttributeOption implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'attribute', 'addToNew', 'position', 'editLanguage', 'translations', '_previous_state');
        }
    ...
    public function setAddToNew($addToNew)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAddToNew', array($addToNew));

        return parent::setAddToNew($addToNew);
    }
