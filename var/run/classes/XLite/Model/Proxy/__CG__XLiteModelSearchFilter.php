 ...
 */
class SearchFilter extends \XLite\Model\SearchFilter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'filterKey', 'parameters', 'suffix', 'editLanguage', 'translations', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SearchFilter $proxy) {
    ...
    public function setFilterKey($filterKey)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFilterKey', array($filterKey));

        return parent::setFilterKey($filterKey);
    }
    ...
    public function getFilterKey()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFilterKey', array());

        return parent::getFilterKey();
    }
