 ...
 */
class PageTranslation extends \XLite\Module\CDev\SimpleCMS\Model\PageTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'teaser', 'body', 'metaKeywords', 'metaTitle', 'label_id', 'code', 'owner', '_previous_state');
        }
