 ...
 */
class ProductClassTranslation extends \XLite\Model\ProductClassTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductClassTranslation $proxy) {
