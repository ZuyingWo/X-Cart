 ...
 */
class State extends \XLite\Model\State implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'state_id', 'state', 'code', 'country', 'region', '_previous_state');
        }
