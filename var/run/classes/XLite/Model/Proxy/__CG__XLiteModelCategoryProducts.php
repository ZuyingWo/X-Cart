 ...
 */
class CategoryProducts extends \XLite\Model\CategoryProducts implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'orderby', 'category', 'product', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CategoryProducts $proxy) {
