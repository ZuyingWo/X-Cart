 ...
 */
class AttributeValueSelectTranslation extends \XLite\Model\AttributeValue\AttributeValueSelectTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AttributeValueSelectTranslation $proxy) {
