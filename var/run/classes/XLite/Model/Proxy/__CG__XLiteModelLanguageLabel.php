 ...
 */
class LanguageLabel extends \XLite\Model\LanguageLabel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'label_id', 'name', 'editLanguage', 'translations', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LanguageLabel $proxy) {
