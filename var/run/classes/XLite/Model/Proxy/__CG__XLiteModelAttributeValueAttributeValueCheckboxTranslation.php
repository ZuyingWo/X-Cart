 ...
 */
class AttributeValueCheckboxTranslation extends \XLite\Model\AttributeValue\AttributeValueCheckboxTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'label_id', 'code', 'owner', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AttributeValueCheckboxTranslation $proxy) {
