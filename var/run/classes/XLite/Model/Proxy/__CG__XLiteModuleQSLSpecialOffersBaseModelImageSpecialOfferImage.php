...
namespace XLite\Model\Proxy\__CG__\XLite\Module\QSL\SpecialOffersBase\Model\Image\SpecialOffer;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Image extends \XLite\Module\QSL\SpecialOffersBase\Model\Image\SpecialOffer\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'specialOffer', 'width', 'height', 'hash', 'needProcess', 'id', 'path', 'fileName', 'mime', 'storageType', 'size', 'date', 'loadError', 'loadErrorMessage', '_previous_state');
        }
    ...
    public function setSpecialOffer(\XLite\Module\QSL\SpecialOffersBase\Model\SpecialOffer $specialOffer = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSpecialOffer', array($specialOffer));
    ...
    public function getSpecialOffer()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSpecialOffer', array());
