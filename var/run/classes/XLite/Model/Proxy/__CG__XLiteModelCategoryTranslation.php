 ...
 */
class CategoryTranslation extends \XLite\Model\CategoryTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'description', 'metaTags', 'metaDesc', 'metaTitle', 'label_id', 'code', 'owner', '_previous_state');
        }
