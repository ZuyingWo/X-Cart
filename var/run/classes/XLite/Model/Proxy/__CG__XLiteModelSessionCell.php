 ...
 */
class SessionCell extends \XLite\Model\SessionCell implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'cell_id', 'name', 'value', 'type', 'session', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SessionCell $proxy) {
