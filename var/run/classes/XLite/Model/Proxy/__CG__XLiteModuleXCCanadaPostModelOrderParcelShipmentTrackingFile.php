 ...
 */
class File extends \XLite\Module\XC\CanadaPost\Model\Order\Parcel\Shipment\Tracking\File implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'docType', 'trackingDetails', 'id', 'path', 'fileName', 'mime', 'storageType', 'size', 'date', 'loadError', 'loadErrorMessage', '_previous_state');
        }
    ...
    public function setDocType($docType)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDocType', array($docType));
    ...
    public function getDocType()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDocType', array());
