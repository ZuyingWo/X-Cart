 ...
 */
class BackendTransactionData extends \XLite\Model\Payment\BackendTransactionData implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'data_id', 'name', 'label', 'access_level', 'value', 'transaction', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BackendTransactionData $proxy) {
    ...
    public function getDataId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDataId', array());
