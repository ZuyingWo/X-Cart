 ...
 */
class ConfigTranslation extends \XLite\Model\ConfigTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'option_name', 'option_comment', 'label_id', 'code', 'owner', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ConfigTranslation $proxy) {
    ...
    public function setOptionComment($optionComment)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOptionComment', array($optionComment));

        return parent::setOptionComment($optionComment);
    }
    ...
    public function getOptionComment()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOptionComment', array());
