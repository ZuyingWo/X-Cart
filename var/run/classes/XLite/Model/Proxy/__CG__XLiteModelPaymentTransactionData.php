 ...
 */
class TransactionData extends \XLite\Model\Payment\TransactionData implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TransactionData $proxy) {
