...
namespace XLite\Model\Proxy\__CG__\XLite\Module\XC\News\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class NewsMessageTranslation extends \XLite\Module\XC\News\Model\NewsMessageTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'body', 'brief_description', 'metaTags', 'metaDesc', 'metaTitle', 'label_id', 'code', 'owner', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NewsMessageTranslation $proxy) {
    ...
    public function setBriefDescription($briefDescription)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBriefDescription', array($briefDescription));

        return parent::setBriefDescription($briefDescription);
    }
    ...
    public function getBriefDescription()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBriefDescription', array());
