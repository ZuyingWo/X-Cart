 ...
 */
class AttributeOptionTranslation extends \XLite\Model\AttributeOptionTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AttributeOptionTranslation $proxy) {
