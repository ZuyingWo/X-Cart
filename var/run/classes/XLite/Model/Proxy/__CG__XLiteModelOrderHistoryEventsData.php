 ...
 */
class OrderHistoryEventsData extends \XLite\Model\OrderHistoryEventsData implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'value', 'event', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OrderHistoryEventsData $proxy) {
