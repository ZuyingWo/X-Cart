...
namespace XLite\Model\Proxy\__CG__\XLite\Module\XC\NewsletterSubscriptions\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Subscriber extends \XLite\Module\XC\NewsletterSubscriptions\Model\Subscriber implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'email', 'profile', '_previous_state');
        }
