 ...
 */
class BannerRotationSlide extends \XLite\Model\BannerRotationSlide implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'enabled', 'image', 'link', 'position', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BannerRotationSlide $proxy) {
    ...
    public function getFrontLink()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFrontLink', array());

        return parent::getFrontLink();
    }
