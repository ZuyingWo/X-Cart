...
class FraudCheckData extends \XLite\Module\CDev\XPaymentsConnector\Model\Payment\FraudCheckData implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'XLite\\Module\\CDev\\XPaymentsConnector\\Model\\Payment\\FraudCheckData' . "\0" . 'kountMessages', '' . "\0" . 'XLite\\Module\\CDev\\XPaymentsConnector\\Model\\Payment\\FraudCheckData' . "\0" . 'noFraudMessages', '' . "\0" . 'XLite\\Module\\CDev\\XPaymentsConnector\\Model\\Payment\\FraudCheckData' . "\0" . 'scoreClass', 'id', 'code', 'service', 'result', 'status', 'score', 'message', 'serviceTransactionId', 'url', 'errors', 'warnings', 'rules', 'data', 'transaction', '_previous_state');
        }
