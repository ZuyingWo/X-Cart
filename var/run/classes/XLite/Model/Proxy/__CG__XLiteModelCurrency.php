...
class Currency extends \XLite\Model\Currency implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'currency_id', 'code', 'symbol', 'prefix', 'suffix', 'e', 'decimalDelimiter', 'thousandDelimiter', 'orders', 'countries', 'editLanguage', 'translations', '_previous_state');
        }
