...
class Cart extends \XLite\Model\Cart implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'xpcForceCalcFlag', 'usedCoupons', 'fraud_status_xpc', 'fraud_type_xpc', 'fraud_check_transaction_id', 'fraudCheckData', 'auctionIncPackage', 'capostParcels', 'capostReturns', 'capostOffice', 'order_id', 'profile', 'orig_profile', 'shipping_id', 'shipping_method_name', 'payment_method_name', 'tracking', 'date', 'lastRenewDate', 'paymentStatus', 'shippingStatus', 'notes', 'adminNotes', 'details', 'trackingNumbers', 'events', 'items', 'surcharges', 'payment_transactions', 'currency', 'orderNumber', 'recent', 'addItemError', 'oldPaymentStatus', 'isRemoving', 'oldShippingStatus', 'modifiers', 'shippingProcessor', 'isNotificationSent', 'ignoreCustomerNotifications', 'isNotificationsAllowedFlag', 'statusIsSet', 'paymentTransactionSums', 'sourceAddress', 'xcPendingExport', 'temporary', 'total', 'subtotal', '_previous_state');
        }
    ...
    public function setXpcForceCalcFlag($force = true)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setXpcForceCalcFlag', array($force));

        return parent::setXpcForceCalcFlag($force);
    }
    ...
    public function setAuctionIncPackage($auctionIncPackage)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAuctionIncPackage', array($auctionIncPackage));

        return parent::setAuctionIncPackage($auctionIncPackage);
    }
    ...
    public function getAuctionIncPackage()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAuctionIncPackage', array());

        return parent::getAuctionIncPackage();
    }
