 ...
 */
class CurrencyTranslation extends \XLite\Model\CurrencyTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CurrencyTranslation $proxy) {
