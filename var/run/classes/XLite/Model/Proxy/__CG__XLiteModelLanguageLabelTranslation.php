 ...
 */
class LanguageLabelTranslation extends \XLite\Model\LanguageLabelTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'label', 'label_id', 'code', 'owner', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LanguageLabelTranslation $proxy) {
