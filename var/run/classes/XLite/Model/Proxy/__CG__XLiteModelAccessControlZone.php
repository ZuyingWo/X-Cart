 ...
 */
class AccessControlZone extends \XLite\Model\AccessControlZone implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'cell', 'type', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AccessControlZone $proxy) {
    ...
    public function setTypeByName($name)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTypeByName', array($name));

        return parent::setTypeByName($name);
    }
    ...
    public function setTypeByZone(\XLite\Model\AccessControlZone $zone)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTypeByZone', array($zone));

        return parent::setTypeByZone($zone);
    }
    ...
    public function checkIdentity($zone)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'checkIdentity', array($zone));

        return parent::checkIdentity($zone);
    }
