...
class Payment extends \XLite\Model\Order\Status\Payment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'code', 'position', 'editLanguage', 'translations', '_previous_state');
        }
    ...
    public function isCompatibleWithShippingStatus()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isCompatibleWithShippingStatus', array());
    ...
    public function isAllowedToSetManually()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isAllowedToSetManually', array());
