 ...
 */
class CountryTranslation extends \XLite\Model\CountryTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'country', 'label_id', 'code', 'owner', '_previous_state');
        }
