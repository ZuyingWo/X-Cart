...
class Page extends \XLite\Module\CDev\SimpleCMS\Model\Page implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'ogMeta', 'showSocialButtons', 'id', 'enabled', 'image', 'cleanURLs', 'metaDescType', 'editLanguage', 'translations', '_previous_state');
        }
    ...
    public function setShowSocialButtons($showSocialButtons)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setShowSocialButtons', array($showSocialButtons));
    ...
    public function getShowSocialButtons()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getShowSocialButtons', array());
