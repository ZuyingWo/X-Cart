...
namespace XLite\Model\Proxy\__CG__\XLite\Model\DataSource;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Parameter extends \XLite\Model\DataSource\Parameter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'dataSource', 'id', 'name', 'value', '_previous_state');
        }
