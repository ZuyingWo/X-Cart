 ...
 */
class TaxTranslation extends \XLite\Module\CDev\SalesTax\Model\TaxTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaxTranslation $proxy) {
