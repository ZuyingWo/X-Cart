 ...
 */
class AddressFieldValue extends \XLite\Model\AddressFieldValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'value', 'addressField', 'address', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AddressFieldValue $proxy) {
    ...
    public function setAddressField(\XLite\Model\AddressField $addressField = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAddressField', array($addressField));

        return parent::setAddressField($addressField);
    }
    ...
    public function getAddressField()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAddressField', array());

        return parent::getAddressField();
    }
