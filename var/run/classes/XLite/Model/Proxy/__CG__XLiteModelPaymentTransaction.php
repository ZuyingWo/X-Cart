...
class Transaction extends \XLite\Model\Payment\Transaction implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'xpc_data', 'fraud_check_data', 'transaction_id', 'date', 'publicTxnId', 'method_name', 'method_local_name', 'status', 'value', 'note', 'type', 'public_id', 'order', 'payment_method', 'data', 'backend_transactions', 'currency', 'readableStatuses', 'registeredCache', '_previous_state');
        }
    ...
    public function getIpnTtl()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIpnTtl', array());

        return parent::getIpnTtl();
    }
    ...
    public function isTtlExpired()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isTtlExpired', array());

        return parent::isTtlExpired();
    }
    ...
    public function hasTtlForIpn()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasTtlForIpn', array());

        return parent::hasTtlForIpn();
    }
    ...
    public function removeTtlForIpn()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeTtlForIpn', array());

        return parent::removeTtlForIpn();
    }
    ...
    public function setTtlForIpn($ttl_time = 3600)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTtlForIpn', array($ttl_time));

        return parent::setTtlForIpn($ttl_time);
    }
