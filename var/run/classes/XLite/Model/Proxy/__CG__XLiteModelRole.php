...
class Role extends \XLite\Model\Role implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'enabled', 'id', 'permissions', 'profiles', 'editLanguage', 'translations', '_previous_state');
        }
    ...
    public function isPermissionAllowedOr($code)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isPermissionAllowedOr', array($code));
    ...
    public function addPermissions(\XLite\Model\Role\Permission $permissions)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPermissions', array($permissions));
