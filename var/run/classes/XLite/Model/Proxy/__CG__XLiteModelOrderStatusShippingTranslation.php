 ...
 */
class ShippingTranslation extends \XLite\Model\Order\Status\ShippingTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'customerName', 'label_id', 'code', 'owner', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ShippingTranslation $proxy) {
