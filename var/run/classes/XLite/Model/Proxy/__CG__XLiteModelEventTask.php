 ...
 */
class EventTask extends \XLite\Model\EventTask implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'arguments', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventTask $proxy) {
    ...
    public function setArguments($arguments)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setArguments', array($arguments));
    ...
    public function getArguments()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getArguments', array());
