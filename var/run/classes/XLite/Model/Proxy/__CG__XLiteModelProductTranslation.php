 ...
 */
class ProductTranslation extends \XLite\Model\ProductTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'description', 'briefDescription', 'metaTags', 'metaDesc', 'metaTitle', 'label_id', 'code', 'owner', '_previous_state');
        }
