...
namespace XLite\Module\CDev\Coupons\View\Checkout;

/**
 * Cart items
 */
abstract class CartItems extends \XLite\View\Checkout\CartItemsAbstract implements \XLite\Base\IDecorator
{
    /**
