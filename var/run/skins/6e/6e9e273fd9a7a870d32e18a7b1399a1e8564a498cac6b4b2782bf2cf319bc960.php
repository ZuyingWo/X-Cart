    ...
    <div class=\"addons-search-box\">
      ...
      ";
        ...
        <div class=\"state\">
          ";
            // line 20
            echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('widget')->getCallable(), array($this->env, $context, array(0 => "\\XLite\\View\\FormField\\Select\\ModuleState", "fieldOnly" => "true", "fieldName" => "state", "value" => $this->getAttribute((isset($context["this"]) ? $context["this"] : null), "getState", array(), "method")))), "html", null, true);
            echo "
        </div>
      ";
...
";
    ...
    {
        return array (  74 => 32,  70 => 31,  66 => 30,  62 => 29,  58 => 28,  51 => 23,  46 => 20,  40 => 17,  36 => 16,  33 => 15,  32 => 14,  24 => 8,  22 => 7,  19 => 6,);
    }
}
/* {##*/
/*  # ____file_title____*/
...
/*         </div>*/
/*         <div class="state">*/
/*           {{ widget('\\XLite\\View\\FormField\\Select\\ModuleState', fieldOnly='true', fieldName='state', value=this.getState()) }}*/
/*         </div>*/
/*       {% endform %}*/
/*   */
/*     </div>*/
