...
<p class=\"email\">";
        ...
        echo ": <a href=\"mailto:";
        echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["this"]) ? $context["this"] : null), "order", array()), "profile", array()), "login", array()), "html", null, true);
        echo "\">";
        echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["this"]) ? $context["this"] : null), "order", array()), "profile", array()), "login", array()), "html", null, true);
        echo "</a></p>
";
    ...
    {
        return array (  51 => 16,  48 => 15,  38 => 11,  34 => 10,  29 => 9,  25 => 8,  19 => 6,);
    }
}
/* {##*/
...
/*   {% endfor %}*/
/* </ul>*/
/* <p class="email">{{ t('E-mail') }}: <a href="mailto:{{ this.order.profile.login }}">{{ this.order.profile.login }}</a></p>*/
/* */
