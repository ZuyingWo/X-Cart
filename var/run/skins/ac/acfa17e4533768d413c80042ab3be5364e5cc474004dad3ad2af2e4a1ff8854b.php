  ...
  <div class=\"update-module-list-frame\">
    ...
    ";
        ...
        if (($this->getAttribute((isset($context["this"]) ? $context["this"] : null), "getNewFeaturesUpgradeEntries", array(), "method") && $this->getAttribute((isset($context["this"]) ? $context["this"] : null), "getHotfixUpgradeEntries", array(), "method"))) {
            // line 20
            echo "      <h2>";
            echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('t')->getCallable(), array("New features")), "html", null, true);
            echo "</h2>
      ...
      <h2>";
            // line 30
            echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('t')->getCallable(), array("Bug-fixes")), "html", null, true);
            echo "</h2>
      <ul class=\"update-module-list clearfix\">
