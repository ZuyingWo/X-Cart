...
";
        ...
        if (($this->getAttribute($this->getAttribute((isset($context["this"]) ? $context["this"] : null), "product", array()), "briefDescription", array()) || $this->getAttribute((isset($context["this"]) ? $context["this"] : null), "isPreview", array(), "method"))) {
            // line 8
            echo "  <div class=\"brief-descr product-description\" data-inline-editable ";
...
/*   <div class="brief-descr product-description" data-inline-editable {{ this.printTagAttributes(this.product.getFieldMetadata('briefDescription'))|raw }} >{{ this.product.getProcessedBriefDescription()|raw }}</div>*/
/* {% endif %}*/
/* */
