...
";
    ...
    {
        return array (  48 => 14,  40 => 12,  38 => 11,  34 => 10,  30 => 9,  26 => 8,  22 => 7,  19 => 6,);
    }
}
/* {##*/
...
/*     <a href="{{ url('order', '', {'order_number': this.order.orderNumber, 'atype': 'b', 'widget': 'XLite\\View\\SelectAddressOrder'}) }}" class="btn btn-default address-book">{{ t('Address book') }}</a>*/
/*   {% endif %}*/
