...
<div class=\"change-template\">
  <div class=\"header\">
    ...
    <div class=\"right\">
      ...
      ";
        // line 20
        echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('widget')->getCallable(), array($this->env, $context, array(0 => "XLite\\View\\Tooltip", "className" => "help-icon", "text" => "If you purchased a template but do not see it here, activate the license key that was provided to you."))), "html", null, true);
        echo "
    </div>
    <div class=\"clear\"></div>
  </div>
...
/* */
/*       {{ widget('XLite\\View\\Tooltip', className='help-icon', text='If you purchased a template but do not see it here, activate the license key that was provided to you.') }}*/
/*     </div>*/
/*     <div class="clear"></div>*/
/*   </div>*/
