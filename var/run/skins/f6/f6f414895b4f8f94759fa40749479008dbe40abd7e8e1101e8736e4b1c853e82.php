...
";
    ...
    <a class=\"checkout_fastlane_shipping_edit_link\" href=\"#\" v-on:click.prevent=\"switchTo('shipping')\">";
            // line 11
...
/*  #*/
/*  # @ListChild (list="checkout_fastlane.sections.details", weight="15")*/
/*  #}*/
/* */
...
/* */
/*     <a class="checkout_fastlane_shipping_edit_link" href="#" v-on:click.prevent="switchTo('shipping')">{{ t('Edit') }}</a>*/
/* </div>*/
/* {% endif %}*/
/* */
