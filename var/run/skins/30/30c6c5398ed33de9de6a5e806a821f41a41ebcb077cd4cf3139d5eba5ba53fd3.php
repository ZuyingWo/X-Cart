...
<td class=\"title-wrapper\">
    ...
    <div class=\"packing-slip-title-data\">
        ...
        echo "</strong>
            <span class=\"date-value\">";
        // line 16
        echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, $this->getAttribute((isset($context["this"]) ? $context["this"] : null), "getShippingMethodName", array(), "method"), "html", null, true);
        echo "</span>
        </div>
...
/*             <span class="date-value">{{ this.getShippingMethodName() }}</span>*/
/*         </div>*/
/*         <div class="packing-slip-title-data-item packing-slip-order-date">*/
