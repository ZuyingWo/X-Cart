...
/*   <td>{{ widget('\\XLite\\View\\CategorySelect', fieldName='categoryId', selectedCategoryIds=[this.getCondition('categoryId')], allOption='1') }}</td>*/
/* </tr>*/
/* */
