...
";
  ...
  <div class=\"alert alert-danger add-new-card-error\">
    ...
    ";
            // line 37
            echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('t')->getCallable(), array("No addresses for the profile.")), "html", null, true);
            echo "
    ";
            // line 38
            echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('widget')->getCallable(), array($this->env, $context, array(0 => "\\XLite\\Module\\CDev\\XPaymentsConnector\\View\\Button\\AddAddress", "label" => "Setup address", "profileId" => $this->getAttribute((isset($context["this"]) ? $context["this"] : null), "getCustomerProfileId", array(), "method")))), "html", null, true);
            echo "
  </div>
